    ...
    return (
        <div className='flex'>
            ...
            <div className='h-full flex-1 p-7 bg-[#EEEFF3]'>
                <Breadcrumb pagename1='Project' pagename2='Project Detail' />
                
                <div className="h-full m-12 bg-[#fff] rounded-lg">
                    <p class ="text-3xl font-bold pl-7 pt-7">RHY Digital Tool </p>
                    ...
                    <div class="m-8 flex justify-end gap-4">   
                        ...
                        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 font-normal rounded text-sm px-6 py-3 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">New Project</button>

                    </div>
                    <div class="h-px m-8 bg-[#ebe8ff]"></div>
                    <p class ="text-2xl font-bold pl-7 pb-6">Project Description</p>
                    <p class ="text-lg font-light px-7">Etiam convallis elementum s, a aliquam turpis aliquam vitae. Praesent sollicitudin felisapien, a aliquam turpa aliquam turpis aliquam vitae. Praesent sois alapien, a aliquam turpis aliquam vitae. Praesent sollicitudin felisapien, a aliquam turpis aliquam vitae. Praesent ss vel mi facilisis posuere. Nulla ultrices facilisis justo, non varius nisl semper vel. Interdum et malesuada fames ac ante ipsum primis in faucibus. Phasellus at ante mattis, condimentum velit et, dignissim nunc. Integer quis tincidunt purus. Duis dignissim mauris vel elit commodo.</p>
