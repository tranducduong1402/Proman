  ...
  const data = [
    {
      id: 1,
      image:
        "https://img.freepik.com/free-photo/happy-young-asian-businessmen-businesswomen-meeting-brainstorming-ideas_7861-3089.jpg?w=1380&t=st=1678794396~exp=1678794996~hmac=589fec1853557f793fe402dc4b9cc13a6d894dbc370a993b1fbedc2ee726df78",
      title: " OFFICE WORK ",
    ...
    <div>
      <div className="mt-9 flex justify-evenly px-[100px] h-[610px] w-full">
        <div className="flex-1 ">
          ...
          <h5 className="text-[#999999] text-[16px] ">
            {" "}
            Use the shortest possible time to create tasks, use all the free
            features to make the most of them and online collaborative
            management platform to bring more than efficiency and performance
            for manage your project beloved{" "}
          </h5>
          <div className="mt-8">
            <button className=" text-white text-xs bg-main_color py-3 px-4 rounded-lg mr-4 hover:opacity-80">
              {" "}
              Learn More{" "}
            </button>
            <button className=" text-main_color border-2 border-main_color rounded-lg py-3 px-4 text-xs font-bold hover:text-white hover:bg-main_color">
              Contact Us
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 ml-6">
          <div className="flex justify-end">
            ...
            <Link to="/login">
              <button className="bg-white text-main_color border-2 border-main_color text-xs w-[115px] h-[44px] rounded-md hover:bg-main_color hover:text-white opacity-80 font-bold">
                Login
              </button>
            </Link>
          </div>
      ...
      <div className="w-full h-[464px] bg-[#F7F7F7] ">
        <div className="pt-12">
          <h4 className=" text-main_color font-normal text-xl text-center">
            {" "}
            Feature{" "}
          </h4>
          <h1 className="text-center text-black font-bold text-4xl mt-2">
            {" "}
            Our Special Feature{" "}
          </h1>
        </div>
          ...
          <div className="flex-[35%]">
            ...
            <div className=" max-w-[360px] max-h-[112px]">
              ...
              <h5 className="text-[#999999] text-[14px] mb-8">
                ...
                excellent features that other task manager app don’t have, so
                task manager can be done easily
              </h5>

              <button className="bg-main_color text-white hover:opacity-80 rounded-lg px-8 py-4">
                Learn More
              </button>
            </div>
          </div>
      ...
      <div className=" h-[786px] w-full bg-[#F0F0F0] ">
        <div className="text-center pt-12 ">
          <h4 className="text-main_color font-medium text-xl mb-3">
            {" "}
            Articles{" "}
          </h4>
        ...
        <div className="flex justify-center mt-12">
          <button className="bg-main_color text-white hover:opacity-80 px-5 py-4 rounded-lg text-sm">
            Read More
          </button>
        </div>
      </div>
      ...
      <div className="mt-32 mx-[120px]">
        <div className="flex h-[540px] w-full bg-white justify-around ">
          <div className=" w-[50%]">
            <h3 className="text-main_color text-[18px] font-medium">
              {" "}
              How It Works{" "}
            </h3>
            ...
            <h4 className="text-[14px] text-[#999999] max-w-[360px] max-h-[72px]">
              If you ever find anything hard, we got 3 option for you! 10+
              Readable Documents, Tutorial Videos that you are can access
              anywhere, and 24/7 Customer Service
            </h4>
          ...
          <div className="w-[50%]">
            <div className="absolute">
              <img
                src={backgroundChart}
                alt=" background_chart"
                className="max-w-[28rem] h-[28rem] object-fill "
              />
            </div>
        ...
        <div className="relative flex justify-around">
          <div className="w-[684px] h-[144px] my-[105px]">
            <h3 className="text-white text-5xl ">
              Build Your System of Project
            </h3>
            <h3 className="text-white text-5xl mt-5">
              {" "}
              Management With PROMAN ?
            </h3>
          </div>
          <div className="mt-[125px]">
            <button className="text-main_color bg-white px-5 py-4 rounded-lg hover:bg-zinc-200">
              Learn More
            </button>
          </div>
        </div>
